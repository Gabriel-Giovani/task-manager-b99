...
$consultTask = $link->query("SELECT * FROM tb_task where resp_task = '$name_user'") or die($link->error);
// Consulta dos dados dos usuários do banco.
$consultUser = $link->query("SELECT name FROM tb_user WHERE name != '$name_user'") or die($link->error);
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 dashboard">
                    ...
                    <div class="col-md-8 col-sm-8 tasks">
                        <h3>Trabalhos em progresso de <?php echo $_SESSION['name_user'] ?></h3>
                    ...
                    <div class="col-md-4 col-sm-4 users">
                        ...
                        <div class="task-table">
                            <table class="table table-bordered table-sm m-0">
                                <tbody>
                                <tr>
                                    <td class="task-id"><?php echo $_SESSION['name_user'] ?> <span class="badge ml-1 badge-danger bg-atr">Você</span></td>
                                </tr>
                                <!-- Obtendo array com os dados do banco e inserindo os valores na tabela -->
                                <?php while($dado = $consultUser->fetch_array()){ ?>
                                    <tr>
                                        <td class="task-id"><?php echo $dado['name'] ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                                <!-- /Obtendo array com os dados do banco e inserindo os valores na tabela -->
